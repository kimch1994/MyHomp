...
<body>
   ...
   <div class="wrap">
      ...
      <span class="right" style="padding: 3px 10px;"><a href="loginafter.jsp"><%=id %>님 &nbsp;  <a href="logout.jsp"><input type="submit" name="Logout"
         ...
         <div class="fileBox">
            ...
            <div id="right_area">
               ...
               <div id="menu">
                  <table>
                     <tr>
                        <td><a href="loginafter.jsp"><label class="btn_file">홈</label></a></td>
                     </tr>
                     <tr>
                     ...
                     <tr>
                        <td><a href="postingafter_mine.jsp"><label class="btn_file">방명록</label></a></td>
                     </tr>
                  </table>
               </div>
            </div>
