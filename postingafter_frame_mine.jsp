...
<body>
	...
	<%
		...
		String from = id; //현재 페이지의 주인 닉네임
		String profile = "mini.jpg"; // 현재 로그인된 사람의 프로필 사진 링크 
	...
	%>
	<form class="" action="post_add_mine.jsp" method="post">
		<table border='1'>
		<tr>
		<td colspan="3" >
	...
	<%
		...
		String sql2 = "select * from bmr where your ='"+id+"' order by bmkNum desc;"; //공개글  
	...
	<table border="1" width="500">
		...
		<tr>
			<td colspan="2">
			<form class="" action="post_reple_add_mine.jsp" method="post">
