...
function deleteCheck()
  {
   ...
   form.submit();
	...
	<div class="wrap">
		...
		<span class="right" style="padding: 3px 10px;">
		<a href="adminafter.jsp"><%=id %>님 &nbsp;  
		<a
               ...
               %>
				...
				<div id="right_area">
					...
					<!--  
                     ...
                     <form method="post" enctype="multipart/form-data" action="imgup_fr.jsp?fr=<%=fr%>">
                     <input type="file" id="ex_file" name="filename e1" accept=".jpg, .jpeg, .png" multiple >
					...
					<div id="menu">
						 <table>
                     <tr>
                        <td><a href="adminfriendrecommandpage.jsp?fr=<%=fr%>"><label class="btn_file">홈</label></a></td>
                     </tr>
                     <tr>
                        <td><a href="adminphotomenu_fr.jsp?fr=<%=fr%>"><label for="uploadBtn"
                              class="btn_file">사진</label></a></td>
                     </tr>
                     <tr>
                        <td><a href="adminpostingafter_fr.jsp?fr=<%=fr%>"><label class="btn_file">방명록</label></a></td>
                     </tr>
                  </table>
					</div>
				</div>
