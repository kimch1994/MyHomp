...
<body>
	...
	<%
		//id passwd가져오기
		String e1 = request.getParameter("user_name"); //입력받는 것
		String e2 = request.getParameter("user_id"); //입력받는 것
		String e3 = request.getParameter("user_phone"); //입력받는 것
		...
		String sql = "";
		try {
			sql = " select passwd from member where name=? && id=? && phone=? ";
