	...
	<div class="wrap">
		...
		<form method="post" action="project_LogIn.jsp" name="LogIn"
			...
			<a id="logo" href="project.html"><strong>MyHomp</strong></a> <span
				...
				value="로그인" id="Login" /> <a href="accountsearch.html"><input
		...
		<form method="post" action="project.jsp" name="userInfo"
			...
			<table>
				...
				<tr>
						<td>출신지(선택)</td>
						<td><input type="text" name="user_hometown" placeholder="친구추천에 도움이 됩니다."/></td>
					</tr>
				<tr>
					<td></td>
					<td><input type="submit" name="submit" value="계정 만들기"
						id="submit" /></td>
				</tr>
			</table>
			</aside>
