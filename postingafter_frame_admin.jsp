...
<body>
	...
	%>
	<form class="" action="post_add_admin.jsp" method="post">
		<table border='1'>
		<tr>
		<td colspan="3" >
	...
	<%
		...
		String sql2 = "select * from bmr where your ='"+id+"' order by bmkNum desc;";
	...
	<table border="1" width="500">
		...
		<tr>
			<td colspan="2">
			<form class="" action="post_reple_add_admin.jsp" method="post">
