...
function deleteCheck()
  {
   ...
   <div class="wrap">
      ...
      <span class="right" style="padding: 3px 10px;"><a href="adminafter.jsp"><%=id %>님 &nbsp;  <a href="logout.jsp"><input type="submit" name="Logout"
      ...
      <div class="section_warp">
         <div class="fileBox">
            ...
            <div id="right_area">
               <strong id="pageid">&nbsp;&nbsp;<%=id%>님 의 미니홈피
               </strong>
               <div id="inner">
                  <div class="filebox">
                     <label for="ex_file">업로드</label> 
                     <form method="post" enctype="multipart/form-data" action="imgup(1).jsp">
               ...
               <div id="menu">
                  <table>
                     <tr>
                        <td><a href="adminafter.jsp"><label class="btn_file">홈</label></a></td>
                     </tr>
                     <tr>
                     ...
                     <tr>
                        <td><a href="postingafter_admin.jsp"><label class="btn_file">방명록</label></a></td>
                     </tr>
                  </table>
               </div>
            </div>
