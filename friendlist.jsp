...
<body>
	...
	<header> <a id="logo" href="loginafter.jsp"><strong>MyHomp</strong></a>
      <span class="right" style="padding: 3px 10px;"><a href="loginafter.jsp"><%=id %>님 &nbsp; <a
		...
		<section class="left">
		<strong>친구 찾기</strong> 
		<form method="post" action="friendlist.jsp" name="SearchID"
		...
		<table>
		<tr>
                     <td><a href="friendpage.jsp?fr=<%=friend_id%>" target="_blank"><%=friend_name%></td>
        			 <!--  <td><%=friend_id %></td> -->
        </tr>
		</table>
		<%
	...
	<aside class="right"> 
		...
		<tr>
		<td id="listname"><a href="friendrecommandpage.jsp?fr=<%= reco_session[count] %>" target="_blank"/><%= recommandname[count] %><br></td>
